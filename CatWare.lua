...
local Window = Library.CreateLib("CatWare 1.4", "RJTheme7")
...
Section:NewButton("Anti-Aim", "These anti-aims make it so that the enemy will miss you.", function()
...
Section:NewButton("Aim", "...",  function()
local ScreenGui1 = Instance.new("ScreenGui", game.CoreGui)
ScreenGui1["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling

local Frame2 = Instance.new("Frame", ScreenGui1)
Frame2["Position"] = UDim2.new(-0.028848961, 0, 0.478696734, 0)
Frame2["BorderColor3"] = Color3.new(0, 0, 0)
Frame2["Size"] = UDim2.new(0, 2000, 0, 3)
Frame2["BorderSizePixel"] = 0
Frame2["BackgroundColor3"] = Color3.new(0, 0, 0)

local Frame3 = Instance.new("Frame", ScreenGui1)
Frame3["Name"] = "Frame2"
Frame3["Position"] = UDim2.new(0.4990848, 0, -0.280701756, 0)
Frame3["BorderColor3"] = Color3.new(0, 0, 0)
Frame3["Size"] = UDim2.new(0, 3, 0, 5000)
...
game.UserInputService.InputBegan:Connect(function(inputObject, gameProcessedEvent)
...
Section:NewSlider("FOV", "Field of view.", 200, 70, function(s)
...
local Box_Color = Color3.fromRGB(252, 250, 255)
local Box_Thickness = 1.4
local Box_Transparency = 1 -- 1 Visible, 0 Not Visible

local Tracers = true
local Tracer_Color = Color3.fromRGB(252, 250, 255)
...
Section:NewButton("Moon 3.3.3", "this hub have other scripts", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/voiddscripts/moon/main/script.lua"))()
end)

Section:NewButton("Kat F*cker", "Allows you to take weapons from enemies and crash b*tches.", function()
loadstring(game:HttpGet(('https://pastebin.com/raw/6G9GfqjC'),true))()
end)

Section:NewButton("Universal", "Normal Script", function()
...
Section:NewButton("Bunny-Hop", "Jumps automatically with added speed.", function()
while wait() do
...
Section:NewButton("Boost for walking speed", "...", function()
while wait() do
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 23
end
end)
...
local Section = Tab:NewSection("Scripter : dimasterskyyy")

local Section = Tab:NewSection("Hubs , Functions : pika , dimasterskyyy")

local Section = Tab:NewSection("Thanks for the work done!")
